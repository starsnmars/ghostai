...
Use Clerk's 'dark' theme from '@clelrk/ui/themes' as the base.
...
Add Cleark's built-in 'UserButton' to the editor navbar right section for profile settings and logout.
